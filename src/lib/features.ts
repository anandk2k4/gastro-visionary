...
export const getAllFeatures = (): Feature[] => {
  return [
    ...
    {
      icon: React.createElement(Camera, { className: "h-6 w-6 text-restaurant-teal" }),
    ...
    {
      icon: React.createElement(Eye, { className: "h-6 w-6 text-restaurant-teal" }),
    ...
    {
      icon: React.createElement(AlertTriangle, { className: "h-6 w-6 text-restaurant-teal" }),
    ...
    {
      icon: React.createElement(Layers, { className: "h-6 w-6 text-restaurant-teal" }),
    ...
    {
      icon: React.createElement(ArrowDownCircle, { className: "h-6 w-6 text-restaurant-teal" }),
    ...
    {
      icon: React.createElement(RefreshCw, { className: "h-6 w-6 text-restaurant-teal" }),
    ...
    {
      icon: React.createElement(BarChart2, { className: "h-6 w-6 text-restaurant-teal" }),
    ...
    {
      icon: React.createElement(ChefHat, { className: "h-6 w-6 text-restaurant-teal" }),
    ...
    {
      icon: React.createElement(DollarSign, { className: "h-6 w-6 text-restaurant-teal" }),
    ...
    {
      icon: React.createElement(Cpu, { className: "h-6 w-6 text-restaurant-teal" }),
    ...
    {
      icon: React.createElement(Utensils, { className: "h-6 w-6 text-restaurant-teal" }),
